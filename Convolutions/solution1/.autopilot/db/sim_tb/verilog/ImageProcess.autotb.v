...
`define AUTOTB_DUT      ImageProcess
`define AUTOTB_DUT_INST AESL_inst_ImageProcess
`define AUTOTB_TOP      apatb_ImageProcess_top
`define AUTOTB_LAT_RESULT_FILE "ImageProcess.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ImageProcess.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ImageProcess_top
...
`define AUTOTB_TVIN_inStream_V_data_V  "./c.ImageProcess.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.ImageProcess.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.ImageProcess.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.ImageProcess.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.ImageProcess.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.ImageProcess.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.ImageProcess.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V  "./c.ImageProcess.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.ImageProcess.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.ImageProcess.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.ImageProcess.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.ImageProcess.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.ImageProcess.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.ImageProcess.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_kernel  "./c.ImageProcess.autotvin_kernel.dat"
`define AUTOTB_TVIN_operation  "./c.ImageProcess.autotvin_operation.dat"
`define AUTOTB_TVIN_inStream_V_data_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.ImageProcess.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.ImageProcess.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_kernel_out_wrapc  "./rtl.ImageProcess.autotvin_kernel.dat"
`define AUTOTB_TVIN_operation_out_wrapc  "./rtl.ImageProcess.autotvin_operation.dat"
`define AUTOTB_TVOUT_outStream_V_data_V  "./c.ImageProcess.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.ImageProcess.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.ImageProcess.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.ImageProcess.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.ImageProcess.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.ImageProcess.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.ImageProcess.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.ImageProcess.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4147844;
...
wire [4 : 0] KERNEL_BUS_AWADDR;
wire  KERNEL_BUS_AWVALID;
wire  KERNEL_BUS_AWREADY;
wire  KERNEL_BUS_WVALID;
wire  KERNEL_BUS_WREADY;
wire [31 : 0] KERNEL_BUS_WDATA;
wire [3 : 0] KERNEL_BUS_WSTRB;
wire [4 : 0] KERNEL_BUS_ARADDR;
wire  KERNEL_BUS_ARVALID;
wire  KERNEL_BUS_ARREADY;
wire  KERNEL_BUS_RVALID;
wire  KERNEL_BUS_RREADY;
wire [31 : 0] KERNEL_BUS_RDATA;
wire [1 : 0] KERNEL_BUS_RRESP;
wire  KERNEL_BUS_BVALID;
wire  KERNEL_BUS_BREADY;
wire [1 : 0] KERNEL_BUS_BRESP;
...
wire KERNEL_BUS_write_data_finish;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .s_axi_KERNEL_BUS_AWADDR(KERNEL_BUS_AWADDR),
    .s_axi_KERNEL_BUS_AWVALID(KERNEL_BUS_AWVALID),
    .s_axi_KERNEL_BUS_AWREADY(KERNEL_BUS_AWREADY),
    .s_axi_KERNEL_BUS_WVALID(KERNEL_BUS_WVALID),
    .s_axi_KERNEL_BUS_WREADY(KERNEL_BUS_WREADY),
    .s_axi_KERNEL_BUS_WDATA(KERNEL_BUS_WDATA),
    .s_axi_KERNEL_BUS_WSTRB(KERNEL_BUS_WSTRB),
    .s_axi_KERNEL_BUS_ARADDR(KERNEL_BUS_ARADDR),
    .s_axi_KERNEL_BUS_ARVALID(KERNEL_BUS_ARVALID),
    .s_axi_KERNEL_BUS_ARREADY(KERNEL_BUS_ARREADY),
    .s_axi_KERNEL_BUS_RVALID(KERNEL_BUS_RVALID),
    .s_axi_KERNEL_BUS_RREADY(KERNEL_BUS_RREADY),
    .s_axi_KERNEL_BUS_RDATA(KERNEL_BUS_RDATA),
    .s_axi_KERNEL_BUS_RRESP(KERNEL_BUS_RRESP),
    .s_axi_KERNEL_BUS_BVALID(KERNEL_BUS_BVALID),
    .s_axi_KERNEL_BUS_BREADY(KERNEL_BUS_BREADY),
    .s_axi_KERNEL_BUS_BRESP(KERNEL_BUS_BRESP),
    .ap_clk(ap_clk),
    .ap_rst_n(ap_rst_n),
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & KERNEL_BUS_write_data_finish & CRTL_BUS_write_data_finish;
...
AESL_axi_slave_KERNEL_BUS AESL_AXI_SLAVE_KERNEL_BUS(
    .clk   (AESL_clock),
    .reset (AESL_reset),
    .TRAN_s_axi_KERNEL_BUS_AWADDR (KERNEL_BUS_AWADDR),
    .TRAN_s_axi_KERNEL_BUS_AWVALID (KERNEL_BUS_AWVALID),
    .TRAN_s_axi_KERNEL_BUS_AWREADY (KERNEL_BUS_AWREADY),
    .TRAN_s_axi_KERNEL_BUS_WVALID (KERNEL_BUS_WVALID),
    .TRAN_s_axi_KERNEL_BUS_WREADY (KERNEL_BUS_WREADY),
    .TRAN_s_axi_KERNEL_BUS_WDATA (KERNEL_BUS_WDATA),
    .TRAN_s_axi_KERNEL_BUS_WSTRB (KERNEL_BUS_WSTRB),
    .TRAN_s_axi_KERNEL_BUS_ARADDR (KERNEL_BUS_ARADDR),
    .TRAN_s_axi_KERNEL_BUS_ARVALID (KERNEL_BUS_ARVALID),
    .TRAN_s_axi_KERNEL_BUS_ARREADY (KERNEL_BUS_ARREADY),
    .TRAN_s_axi_KERNEL_BUS_RVALID (KERNEL_BUS_RVALID),
    .TRAN_s_axi_KERNEL_BUS_RREADY (KERNEL_BUS_RREADY),
    .TRAN_s_axi_KERNEL_BUS_RDATA (KERNEL_BUS_RDATA),
    .TRAN_s_axi_KERNEL_BUS_RRESP (KERNEL_BUS_RRESP),
    .TRAN_s_axi_KERNEL_BUS_BVALID (KERNEL_BUS_BVALID),
    .TRAN_s_axi_KERNEL_BUS_BREADY (KERNEL_BUS_BREADY),
    .TRAN_s_axi_KERNEL_BUS_BRESP (KERNEL_BUS_BRESP),
    .TRAN_KERNEL_BUS_write_data_finish(KERNEL_BUS_write_data_finish),
    .TRAN_KERNEL_BUS_ready_in (AESL_slave_ready),
    .TRAN_KERNEL_BUS_done_in (AESL_slave_output_done),
    .TRAN_KERNEL_BUS_idle_in (AESL_idle),
    .TRAN_KERNEL_BUS_transaction_done_in (AESL_done_delay),
    .TRAN_KERNEL_BUS_start_in  (AESL_slave_start)
);
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_data_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_keep_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_strb_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_user_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_last_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_id_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.ImageProcess.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.ImageProcess.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.ImageProcess.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.ImageProcess.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.ImageProcess.autotvout_outStream_V_dest_V.dat with impl_rtl.ImageProcess.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
