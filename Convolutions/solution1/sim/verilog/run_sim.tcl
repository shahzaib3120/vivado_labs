...
if {[file isfile ImageProcess.autotvin.dat]} {
	file delete -force ImageProcess.autotvin.dat
}

if {[file isfile ImageProcess.autotvout.dat]} {
	file delete -force ImageProcess.autotvout.dat
}
