...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ImageProcess.autotvin.dat"
	set constFileTvOut       "ImageProcess.autotvout.dat"
	set constFileHdlTvIn     "ImageProcess.autohdltvin.dat"
	set constFileHdlTvOut    "ImageProcess.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
