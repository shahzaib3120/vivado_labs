...
#define AUTOTB_TVOUT_PC_outStream_V_data_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_data_V.dat"
// tvout file define: "outStream_V_keep_V"
#define AUTOTB_TVOUT_PC_outStream_V_keep_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_keep_V.dat"
// tvout file define: "outStream_V_strb_V"
#define AUTOTB_TVOUT_PC_outStream_V_strb_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_strb_V.dat"
// tvout file define: "outStream_V_user_V"
#define AUTOTB_TVOUT_PC_outStream_V_user_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_user_V.dat"
// tvout file define: "outStream_V_last_V"
#define AUTOTB_TVOUT_PC_outStream_V_last_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_last_V.dat"
// tvout file define: "outStream_V_id_V"
#define AUTOTB_TVOUT_PC_outStream_V_id_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_id_V.dat"
// tvout file define: "outStream_V_dest_V"
#define AUTOTB_TVOUT_PC_outStream_V_dest_V  "../tv/rtldatafile/rtl.ImageProcess.autotvout_outStream_V_dest_V.dat"
...
int operation)
{
	...
	else
	{
		...
		sc_bv<8>* kernel_tvin_wrapc_buffer = new sc_bv<8>[9];
				...
				// celement: kernel(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 8; i_0 += 1)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							kernel_tvin_wrapc_buffer[hls_map_index].range(7, 0) = kernel_tmp_mem.range(7, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		sc_bv<32> operation_tvin_wrapc_buffer;

		// RTL Name: operation
		{
			// bitslice(31, 0)
			{
				// celement: operation(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						...
						{
							sc_lv<32> operation_tmp_mem;
							operation_tmp_mem = operation;
							operation_tvin_wrapc_buffer.range(31, 0) = operation_tmp_mem.range(31, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		ImageProcess(inStream, outStream, kernel, operation);
