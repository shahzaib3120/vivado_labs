...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "divide.autotvin.dat"
	set constFileTvOut       "divide.autotvout.dat"
	set constFileHdlTvIn     "divide.autohdltvin.dat"
	set constFileHdlTvOut    "divide.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
