...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "find.autotvin.dat"
	set constFileTvOut       "find.autotvout.dat"
	set constFileHdlTvIn     "find.autohdltvin.dat"
	set constFileHdlTvOut    "find.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
