...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.simpleALU.autotvin_inA_V.dat"
         "c.simpleALU.autotvin_inB_V.dat"
         "c.simpleALU.autotvin_op_V.dat"
         "c.simpleALU.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.simpleALU.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
