...
if {[file isfile simpleALU.autotvin.dat]} {
	file delete -force simpleALU.autotvin.dat
}

if {[file isfile simpleALU.autotvout.dat]} {
	file delete -force simpleALU.autotvout.dat
}
