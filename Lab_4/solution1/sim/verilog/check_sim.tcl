...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.distPoints_fix.autotvin_x1_V.dat"
         "c.distPoints_fix.autotvin_y1_V.dat"
         "c.distPoints_fix.autotvin_x2_V.dat"
         "c.distPoints_fix.autotvin_y2_V.dat"
         "c.distPoints_fix.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.distPoints_fix.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
