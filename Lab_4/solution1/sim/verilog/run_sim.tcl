...
if {[file isfile distPoints_fix.autotvin.dat]} {
	file delete -force distPoints_fix.autotvin.dat
}

if {[file isfile distPoints_fix.autotvout.dat]} {
	file delete -force distPoints_fix.autotvout.dat
}
