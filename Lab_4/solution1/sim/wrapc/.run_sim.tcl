...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado/2018.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "distPoints_fix.autotvin.dat"
	set constFileTvOut       "distPoints_fix.autotvout.dat"
	set constFileHdlTvIn     "distPoints_fix.autohdltvin.dat"
	set constFileHdlTvOut    "distPoints_fix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
