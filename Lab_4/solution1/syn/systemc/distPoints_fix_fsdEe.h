...
#ifndef __distPoints_fix_fsdEe__HH__
#define __distPoints_fix_fsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distPoints_fix_fsdEe) {
    ...
    SC_CTOR(distPoints_fix_fsdEe):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
