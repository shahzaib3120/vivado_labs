...
#ifndef __distPoints_fix_mafYi__HH__
#define __distPoints_fix_mafYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(distPoints_fix_mafYi) {
    ...
    SC_CTOR(distPoints_fix_mafYi):  simcore_mac_0_U ("simcore_mac_0_U") {
