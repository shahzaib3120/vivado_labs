...
#ifndef __distPoints_fix_mueOg__HH__
#define __distPoints_fix_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(distPoints_fix_mueOg) {
    ...
    SC_CTOR(distPoints_fix_mueOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
