...
#ifndef __distPoints_fix_uibkb__HH__
#define __distPoints_fix_uibkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(distPoints_fix_uibkb) {
    ...
    SC_CTOR(distPoints_fix_uibkb):  ACMP_uitofp_U ("ACMP_uitofp_U") {
