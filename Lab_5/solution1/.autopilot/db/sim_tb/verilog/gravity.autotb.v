...
`define AUTOTB_DUT      gravity
`define AUTOTB_DUT_INST AESL_inst_gravity
`define AUTOTB_TOP      apatb_gravity_top
`define AUTOTB_LAT_RESULT_FILE "gravity.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gravity.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gravity_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_m1 1
`define AESL_DEPTH_m2 1
`define AESL_DEPTH_distance 1
`define AUTOTB_TVIN_m1  "./c.gravity.autotvin_m1.dat"
`define AUTOTB_TVIN_m2  "./c.gravity.autotvin_m2.dat"
`define AUTOTB_TVIN_distance  "./c.gravity.autotvin_distance.dat"
`define AUTOTB_TVIN_m1_out_wrapc  "./rtl.gravity.autotvin_m1.dat"
`define AUTOTB_TVIN_m2_out_wrapc  "./rtl.gravity.autotvin_m2.dat"
`define AUTOTB_TVIN_distance_out_wrapc  "./rtl.gravity.autotvin_distance.dat"
`define AUTOTB_TVOUT_ap_return  "./c.gravity.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.gravity.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 24;
parameter LENGTH_m1 = 1;
parameter LENGTH_m2 = 1;
parameter LENGTH_distance = 1;
...
wire ready;
wire ready_wire;
wire [5 : 0] CRTLS_AWADDR;
wire  CRTLS_AWVALID;
wire  CRTLS_AWREADY;
wire  CRTLS_WVALID;
wire  CRTLS_WREADY;
wire [31 : 0] CRTLS_WDATA;
wire [3 : 0] CRTLS_WSTRB;
wire [5 : 0] CRTLS_ARADDR;
wire  CRTLS_ARVALID;
wire  CRTLS_ARREADY;
wire  CRTLS_RVALID;
wire  CRTLS_RREADY;
wire [31 : 0] CRTLS_RDATA;
wire [1 : 0] CRTLS_RRESP;
wire  CRTLS_BVALID;
wire  CRTLS_BREADY;
wire [1 : 0] CRTLS_BRESP;
wire  CRTLS_INTERRUPT;
integer done_cnt = 0;
...
wire CRTLS_read_data_finish;
wire CRTLS_write_data_finish;
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & CRTLS_write_data_finish;
  assign AESL_slave_start = AESL_slave_write_start_finish;
  assign AESL_done = slave_done_status  & CRTLS_read_data_finish;
...
AESL_axi_slave_CRTLS AESL_AXI_SLAVE_CRTLS(
    .clk   (AESL_clock),
    .reset (AESL_reset),
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.gravity.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.gravity.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.gravity.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.gravity.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.gravity.autotvout_ap_return.dat with impl_rtl.gravity.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_m1;
reg [31:0] size_m1;
reg [31:0] size_m1_backup;
reg end_m2;
reg [31:0] size_m2;
reg [31:0] size_m2_backup;
reg end_distance;
reg [31:0] size_distance;
reg [31:0] size_distance_backup;
reg end_ap_return;
