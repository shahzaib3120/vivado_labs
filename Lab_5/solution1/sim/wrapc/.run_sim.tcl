...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gravity.autotvin.dat"
	set constFileTvOut       "gravity.autotvout.dat"
	set constFileHdlTvIn     "gravity.autohdltvin.dat"
	set constFileHdlTvOut    "gravity.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
