...
set out_width 30
set exp i0*i1
set arg_lists {i0 {15 0 +} i1 {15 1 +} p {30 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set ID 23
set hasByteEnable 0
set MemName mathFunction_ref_bkb
...
set ID 24
set hasByteEnable 0
set MemName mathFunction_secocud
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 30
set AddrRange 256
...
set ID 25
set hasByteEnable 0
set MemName mathFunction_secodEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 23
set AddrRange 256
...
set ID 26
set hasByteEnable 0
set MemName mathFunction_secoeOg
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 15
set AddrRange 256
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 27 \
			corename mathFunction_CRTL_BUS_axilite \
			name mathFunction_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mathFunction_CRTL_BUS_s_axi
}
