...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mathFunction.autotvin_x.dat"
         "c.mathFunction.autotvin_y.dat"
         "c.mathFunction.autotvin_res.dat"
         "c.mathFunction.autotvout_res.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mathFunction.autotvout_res.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
