...
`define AUTOTB_DUT      mathFunction
`define AUTOTB_DUT_INST AESL_inst_mathFunction
`define AUTOTB_TOP      apatb_mathFunction_top
`define AUTOTB_LAT_RESULT_FILE "mathFunction.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mathFunction.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mathFunction_top
...
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.mathFunction.autotvin_x.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.mathFunction.autotvin_y.dat"
`define AUTOTB_TVIN_res_out_wrapc  "../tv/rtldatafile/rtl.mathFunction.autotvin_res.dat"
`define AUTOTB_TVOUT_res  "../tv/cdatafile/c.mathFunction.autotvout_res.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "../tv/rtldatafile/rtl.mathFunction.autotvout_res.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4101;
