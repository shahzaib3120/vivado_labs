...
if {[file isfile mathFunction.autotvin.dat]} {
	file delete -force mathFunction.autotvin.dat
}

if {[file isfile mathFunction.autotvout.dat]} {
	file delete -force mathFunction.autotvout.dat
}
