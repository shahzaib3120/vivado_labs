...
#ifndef __mathFunction_fsqrhbi__HH__
#define __mathFunction_fsqrhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mathFunction_fsqrhbi) {
    ...
    SC_CTOR(mathFunction_fsqrhbi):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
