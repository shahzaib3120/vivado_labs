...
#ifndef __mathFunction_mul_jbC__HH__
#define __mathFunction_mul_jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mathFunction_mul_jbC) {
    ...
    SC_CTOR(mathFunction_mul_jbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
