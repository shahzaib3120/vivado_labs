...
#ifndef __mathFunction_mul_mb6__HH__
#define __mathFunction_mul_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mathFunction_mul_mb6) {
    ...
    SC_CTOR(mathFunction_mul_mb6):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
