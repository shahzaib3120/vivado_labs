...
#ifndef __mathFunction_mul_ncg__HH__
#define __mathFunction_mul_ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mathFunction_mul_ncg) {
    ...
    SC_CTOR(mathFunction_mul_ncg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
