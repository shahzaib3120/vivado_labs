...
#ifndef __mathFunction_ref_bkb_H__
#define __mathFunction_ref_bkb_H__
...
struct mathFunction_ref_bkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(mathFunction_ref_bkb_ram) {
...
SC_MODULE(mathFunction_ref_bkb) {
...
mathFunction_ref_bkb_ram* meminst;


SC_CTOR(mathFunction_ref_bkb) {
meminst = new mathFunction_ref_bkb_ram("mathFunction_ref_bkb_ram");
