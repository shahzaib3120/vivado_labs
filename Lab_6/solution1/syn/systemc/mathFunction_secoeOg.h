...
#ifndef __mathFunction_secoeOg_H__
#define __mathFunction_secoeOg_H__
...
struct mathFunction_secoeOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(mathFunction_secoeOg_ram) {
...
SC_MODULE(mathFunction_secoeOg) {
...
mathFunction_secoeOg_ram* meminst;


SC_CTOR(mathFunction_secoeOg) {
meminst = new mathFunction_secoeOg_ram("mathFunction_secoeOg_ram");
