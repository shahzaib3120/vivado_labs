...
entity mathFunction_ref_bkb_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of mathFunction_ref_bkb_rom is 
...
entity mathFunction_ref_bkb is
    generic (
...
architecture arch of mathFunction_ref_bkb is
    component mathFunction_ref_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mathFunction_ref_bkb_rom_U :  component mathFunction_ref_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
