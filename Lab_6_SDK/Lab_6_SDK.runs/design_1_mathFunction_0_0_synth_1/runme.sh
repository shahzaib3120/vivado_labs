...
HD_PWD='F:/Machine-Learning/vivado_labs/Lab_6_SDK/Lab_6_SDK.runs/design_1_mathFunction_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mathFunction_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mathFunction_0_0.tcl
