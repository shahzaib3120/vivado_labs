...
//------------------------Parameter----------------------
localparam
    ADDR_VALUE_R_DATA_0 = 5'h10,
    ADDR_VALUE_R_CTRL   = 5'h14,
    ADDR_SIZE_DATA_0    = 5'h18,
    ADDR_SIZE_CTRL      = 5'h1c,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_VALUE_R_DATA_0)
            int_value_r[7:0] <= (WDATA[31:0] & wmask) | (int_value_r[7:0] & ~wmask);
    end
end
