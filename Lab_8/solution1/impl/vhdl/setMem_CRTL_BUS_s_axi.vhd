...
entity setMem_CRTL_BUS_s_axi is
generic (
...
end entity setMem_CRTL_BUS_s_axi;
...
architecture behave of setMem_CRTL_BUS_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_VALUE_R_DATA_0 : INTEGER := 16#10#;
    constant ADDR_VALUE_R_CTRL   : INTEGER := 16#14#;
    ...
    -- internal registers
    signal int_value_r         : UNSIGNED(7 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_VALUE_R_DATA_0 =>
                        rdata_data <= RESIZE(int_value_r(7 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_VALUE_R_DATA_0) then
                    int_value_r(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_value_r(7 downto 0));
                end if;
            end if;
        end if;
    end process;
