...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.setMem.autotvin_value_r.dat"
         "c.setMem.autotvin_address.dat"
         "c.setMem.autotvin_size.dat"
         "c.setMem.autotvout_MASTER.dat"
         "c.setMem.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.setMem.autotvout_MASTER.dat"
         "rtl.setMem.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
