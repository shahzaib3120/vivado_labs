set C_TypeInfoList {{ 
"Normalize" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"xMin": [[], {"scalar": "unsigned char"}] }, {"xMax": [[], {"scalar": "unsigned char"}] }],[],""], 
"0": [ "stream<ap_axiu<8, 2, 5, 6> >", {"hls_type": {"stream": [[[[],"1"]],"2"]}}], 
"1": [ "ap_axiu<8, 2, 5, 6>", {"struct": [[{"pack": 1}],[{"D":[[], {"scalar": { "int": 8}}]},{"U":[[], {"scalar": { "int": 2}}]},{"TI":[[], {"scalar": { "int": 5}}]},{"TD":[[], {"scalar": { "int": 6}}]}],[{ "data": [[], "3"]},{ "keep": [[], "4"]},{ "strb": [[], "4"]},{ "user": [[], "5"]},{ "last": [[], "4"]},{ "id": [[], "6"]},{ "dest": [[], "7"]}],""]}], 
...
set C_modelArgMapList {[ 
	{ "Name" : "inStream_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "inStream.V.data.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "xMin", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "xMin","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "xMax", "interface" : "axi_slave", "bundle":"CRTL_BUS","type":"ap_none","bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "xMax","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CRTL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "AWADDR" },"address":[{"name":"Normalize","role":"start","value":"0","valid_bit":"0"},{"name":"Normalize","role":"continue","value":"0","valid_bit":"4"},{"name":"Normalize","role":"auto_start","value":"0","valid_bit":"7"},{"name":"xMin","role":"data","value":"16"},{"name":"xMax","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_CRTL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "ARADDR" },"address":[{"name":"Normalize","role":"start","value":"0","valid_bit":"0"},{"name":"Normalize","role":"done","value":"0","valid_bit":"1"},{"name":"Normalize","role":"idle","value":"0","valid_bit":"2"},{"name":"Normalize","role":"ready","value":"0","valid_bit":"3"},{"name":"Normalize","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2227207", "EstimateLatencyMax" : "2227207",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Normalize_CRTL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Normalize_fmul_32bkb_U1", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Normalize_fdiv_32cud_U2", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Normalize_sitofp_dEe_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Normalize {
		inStream_V_data_V {Type I LastRead 7 FirstWrite -1}
		...
		outStream_V_data_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_keep_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_strb_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_user_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_last_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_id_V {Type O LastRead -1 FirstWrite 34}
		outStream_V_dest_V {Type O LastRead -1 FirstWrite 34}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2227207", "Max" : "2227207"}
	, {"Name" : "Interval", "Min" : "2227208", "Max" : "2227208"}
]}
