...
if {[file isfile Normalize.autotvin.dat]} {
	file delete -force Normalize.autotvin.dat
}

if {[file isfile Normalize.autotvout.dat]} {
	file delete -force Normalize.autotvout.dat
}
