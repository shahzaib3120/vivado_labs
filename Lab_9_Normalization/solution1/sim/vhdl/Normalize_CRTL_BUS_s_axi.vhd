...
entity Normalize_CRTL_BUS_s_axi is
generic (
...
end entity Normalize_CRTL_BUS_s_axi;
...
architecture behave of Normalize_CRTL_BUS_s_axi is
    ...
    signal int_xMin            : UNSIGNED(7 downto 0) := (others => '0');
    signal int_xMax            : UNSIGNED(7 downto 0) := (others => '0');
