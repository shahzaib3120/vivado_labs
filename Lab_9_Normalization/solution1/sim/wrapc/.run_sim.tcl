...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Normalize.autotvin.dat"
	set constFileTvOut       "Normalize.autotvout.dat"
	set constFileHdlTvIn     "Normalize.autohdltvin.dat"
	set constFileHdlTvOut    "Normalize.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
