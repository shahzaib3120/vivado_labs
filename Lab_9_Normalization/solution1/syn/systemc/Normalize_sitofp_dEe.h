...
#ifndef __Normalize_sitofp_dEe__HH__
#define __Normalize_sitofp_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Normalize_sitofp_dEe) {
    ...
    SC_CTOR(Normalize_sitofp_dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
